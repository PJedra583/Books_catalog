...
b) The final build is in the `dist/` folder containing the HTML, bundled JS, and assets.  
c) Open `index.html` in a browser to view the app.

## Project Structure
- **src/** — main application logic (main.js), styles (main.css), optional utils.  
